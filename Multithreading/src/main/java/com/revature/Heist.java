...
public class Heist {
	...
	private static abstract class HackerThread extends Thread {
		...
		public HackerThread(Vault vault) {
			super(); // super doesn't really do anything for the Thread interface
			this.vault = vault;
	...
	private static class AscendingHackerThread extends HackerThread {
		...
		@Override 
		public void run() {
			// iterate from 0 to MAX_PASSWORD and check the vault's isCorrectPassword
	...
	private static class PoliceThread extends Thread {
		...
		public void run() {
			...
			System.out.println("Game over for you Havkers!");
			System.exit(0);
		}
